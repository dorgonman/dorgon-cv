...
\CVItem{2018-04-Current, \textit{NeoBards Entertainment}, Principal Programmer}{
  ...
  \begin{itemize}
    ...
    \item Internal Projects using UnrealEngine: Architecture Design, OSS, AI, Quest, Dialogue, Optimization, and Localization workflow.
    \item CI/CD using Teamcity: From DailyBuild, Patch, Perforce/UnrealGameSync Integration and Deploy to Steam.
    \item Crash Report integration for UnrealEngine: using AppCenter for mobile project.
  \end{itemize}
}
...

{
  \begin{itemize}
    ...
    \item Horizon VR Plugin, released on Nov 8, 2017: \\
