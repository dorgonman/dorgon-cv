...
\aboutme{About Me}{
  ...
  Currently working on VR Projects for B2B using Unreal Engine 4.
}
...
\CVItem{2016/12-Current, \href{https://www.mai.ai/}{\textit{Medical Augmented Intelligence}}, Software Architect}{
  As a main programmer, develop following VR Projects and functions using UE4:
  \begin{itemize}
    ...
    \item Visualizing medical images using Volume Render Algorithm in VR(B2B, Support Vive and Oculus)
...
\bluebullet Shell Script &  \bluebullet Python \\
\end{tabular}}
