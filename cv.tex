...
\aboutme{About Me}{
  ...
  Currently working on Game Projects using UnrealEngine 4.
}

% 善長遊戲程式設計與流程自動化，擁有多個遊戲與VR專案開發經驗。
% 目前專注於研究UE4相關技術與應用。 game devlop techniques using UnrealEngine 4
...
\CVItem{2018-04-Current, \textit{Neobards Entertainment}, Senior Software Engineer}{
  Working on Game Projects using UnrealEngine 4
}

\CVItem{2016/12-2018-03, \href{https://www.mai.ai/}{\textit{Medical Augmented Intelligence}}, Software Architect}{
  As a main programmer, develop following VR Projects using UnrealEngine 4:
  \begin{itemize}
